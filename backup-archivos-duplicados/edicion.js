    ...
    const handleSave = () => {
        ...
        if (isEditMode && parsedPokemon && entry) {
            if (state.showdownText) {
                pokemonIndexToUpdate = team.findIndex(p => p.name === parsedPokemon.name &&
