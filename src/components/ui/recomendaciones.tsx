...
export default function RecomendacionesHero() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center mt-8 mb-2">
      <div className="p-1 rounded-2xl bg-gradient-to-r from-yellow-400 via-pink-500 to-blue-500 w-full max-w-md mx-auto">
        <div
          className="relative w-full rounded-xl flex flex-col items-center animate-fade-in bg-clip-padding px-6 py-5 shadow-xl"
          style={{
            background: 'rgba(255,255,255,)', 
            backdropFilter: 'blur(2px)',
          }}
        >
          <p className="text-m sm:text-m font-bold text-white-800 text-center italic mb-2 drop-shadow-md" style={{textShadow: '0 1px 8px #fff8'}}>
            “{reco.texto}”
          </p>
          <span className="text-xs font-bold text-gray-800 flex items-center gap-1 drop-shadow-md">
            {reco.usuario}
          </span>
        </div>
      </div>
<a href="https://www.instagram.com/p/Cq9EOrsvpVV/" target="_blank" rel="noopener noreferrer" className="text-[#E4405F] underline hover:text-[#C13584] transition-colors"></a>
    </div>
  );
}
