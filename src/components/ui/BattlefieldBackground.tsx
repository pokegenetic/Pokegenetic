...
export const BattlefieldBackground: React.FC<BattlefieldBackgroundProps> = ({ gymType }) => {
  ...
  return (
    ...
    >
      {/* Líneas de perspectiva del campo de batalla */}
      <div className="absolute inset-0">
        {/* Línea horizontal central */}
        <div className="absolute top-1/2 left-0 right-0 h-1 bg-white/20 transform -translate-y-0.5"></div>
        
        {/* Líneas de perspectiva */}
        <div className="absolute bottom-0 left-1/4 w-1 h-1/2 bg-white/10 transform -skew-x-12 origin-bottom"></div>
        <div className="absolute bottom-0 right-1/4 w-1 h-1/2 bg-white/10 transform skew-x-12 origin-bottom"></div>
        
        {/* Círculos del campo */}
        <div className="absolute top-1/3 left-1/4 w-8 h-8 border-2 border-white/20 rounded-full"></div>
        <div className="absolute bottom-1/3 right-1/4 w-8 h-8 border-2 border-white/20 rounded-full"></div>
      </div>
