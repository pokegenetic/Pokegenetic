...
import { setUserPokeballs, DEFAULT_BALLS } from './pokeballs';
...
function isValidRegionalForm(pokemon) {
    ...
    if (!/-alola(n)?$|-(galar|galarian)$|-(hisui|hisuian)$/.test(pokemon.name.toLowerCase()))
        return true;
...
export default function PokemonCatchGo() {
    ...
    const [pokeballAnim, setPokeballAnim] = useState('idle');
    ...
    const [pokeballLandingPos, setPokeballLandingPos] = useState(null);
        ...
        if (pokemonAnim === 'escape') {
            ...
            function shake() {
                ...
                if (frame < 18)
                    ...
                    setPokemonIdle(idle => ({ ...idle, shake: 0 }));
            }
            shake();
        }
    }, [pokemonAnim]);
    ...
    async function handleThrow() {
        if (throwing || caught || balls[selectedBall] <= 0)
            return;
        setThrowing(true);
...
Será agregado a tu equipo`);
    ...
    function PokeballSelector() {
        ...
        return (_jsxs(_Fragment, { children: [_jsx("button", { onClick: handleAddAllBalls, style: {
                        marginBottom: 18,
                        marginLeft: 0,
                        marginRight: 0,
                        padding: '8px 18px',
                        ...
                        left: 24,
                        top: '10vh',
                    }, children: "+10 Pok\u00E9balls de cada tipo (test)" }), !showBallSelector && (_jsx("button", { onClick: () => setShowBallSelector(true), style: {
                        position: 'fixed',
                        left: 24,
                        bottom: '10vh',
                        zIndex: 1001,
                        ...
                        outline: 'none',
                        padding: 0,
                    }, "aria-label": "Elegir Pok\u00E9ball", children: _jsx("img", { src: getPokeballSprite(selectedBall), alt: "Pok\u00E9ball actual", style: { width: 48, height: 48, filter: 'drop-shadow(0 2px 8px #43cea288)' }, draggable: false }) })), showBallSelector && (_jsxs("div", { style: {
                        position: 'fixed',
                        left: 24,
                        top: '50%',
                        ...
                        animation: 'fadeInBallSelector 0.18s',
                    }, children: [allBallKeys.map(ballKey => (_jsxs("button", { onClick: () => {
                                ...
                                opacity: balls[ballKey] > 0 ? 1 : 0.4,
                            }, "aria-label": `Seleccionar ${ballKey}`, disabled: balls[ballKey] === 0, children: [_jsx("img", { src: getPokeballSprite(ballKey), alt: ballKey, style: { width: 36, height: 36, filter: selectedBall === ballKey ? 'drop-shadow(0 0 8px #43cea2)' : 'none' }, draggable: false }), _jsx("span", { style: {
                                        position: 'absolute',
                                        bottom: 2,
                                        right: 6,
                                        fontSize: 14,
                                    ...
                                    }, children: balls[ballKey] || 0 })] }, ballKey))), _jsx("button", { onClick: () => setShowBallSelector(false), style: {
                                marginTop: 10,
                                background: 'none',
                                border: 'none',
                                color: '#185a9d',
    ...
    function CaptureStars() {
        return (_jsxs("div", { className: "catch-stars", style: {
                position: 'absolute',
                left: '50%',
                top: '50%',
                ...
                width: 180,
                height: 180,
            }, children: [_jsx("div", { className: "star star1", style: { position: 'absolute', left: 10, top: 30, width: 52, height: 50, animation: 'star-pop1 1.2s ease-out' }, children: _jsx("svg", { viewBox: "0 0 52.95 50.35", children: _jsx("polygon", { fill: "#e8e73c", points: "26.47 0 32.72 19.23 52.95 19.23 36.58 31.12 42.83 50.35 26.47 38.47 10.11 50.35 16.36 31.12 0 19.23 20.22 19.23 26.47 0" }) }) }), _jsx("div", { className: "star star2", style: { position: 'absolute', left: 100, top: 0, width: 52, height: 50, animation: 'star-pop2 1.3s ease-out' }, children: _jsx("svg", { viewBox: "0 0 52.95 50.35", children: _jsx("polygon", { fill: "#e8e73c", points: "26.47 0 32.72 19.23 52.95 19.23 36.58 31.12 42.83 50.35 26.47 38.47 10.11 50.35 16.36 31.12 0 19.23 20.22 19.23 26.47 0" }) }) }), _jsx("div", { className: "star star3", style: { position: 'absolute', left: 60, top: 100, width: 52, height: 50, animation: 'star-pop3 1.4s ease-out' }, children: _jsx("svg", { viewBox: "0 0 52.95 50.35", children: _jsx("polygon", { fill: "#e8e73c", points: "26.47 0 32.72 19.23 52.95 19.23 36.58 31.12 42.83 50.35 26.47 38.47 10.11 50.35 16.36 31.12 0 19.23 20.22 19.23 26.47 0" }) }) })] }));
    }
    ...
    function CaptureConfetti() {
        ...
        return (_jsxs("div", { style: {
                ...
                zIndex: -2,
                transform: 'translate(-50%, -50%)',
            }, children: [confetti.map((c, i) => (_jsx("div", { className: `confetti-real-${i}`, style: {
                        position: 'absolute',
                        left: 0,
                        top: 0,
                        width: 12,
        ...
        ` }), confetti.map((c, i) => (_jsx("style", { children: `
    ...
    const showPokeball = (caught && pokeballAnim === 'success') ||
        (pokeballAnim === 'fail') ||
    ...
    function RenderParticles() {
        return (_jsx("div", { style: {
                ...
                zIndex: 350,
                pointerEvents: 'none',
            }, children: [...Array(18)].map((_, i) => (_jsx("div", { style: {
                    position: 'absolute',
                    width: 18,
                    height: 18,
                    borderRadius: '50%',
    ...
    function RenderClouds() {
        return (_jsx(_Fragment, { children: [0, 1, 2, 3].map(i => (_jsx("div", { style: {
                    position: 'fixed',
                    top: `${8 + i * 7}vh`,
                    left: `${10 + i * 22}%`,
                    width: 180 + i * 30,
    ...
    return (_jsxs("div", { ref: areaRef, style: {
            position: 'relative',
        ...
        ` }), _jsx("div", { style: { ...bgStyle, transform: `scale(${cameraZoom}) translateY(-${cameraY}px)`, transition: 'transform 0.7s cubic-bezier(.7,1.5,.7,1.1)' } }), _jsx(RenderClouds, {}), showParticles && _jsx(RenderParticles, {}), showFlash && _jsx(RenderFlash, {}), pokemon && !caught && balls[selectedBall] > 0 && !zoomToBall && (_jsx("div", { style: { marginTop: 24, marginBottom: 8, fontWeight: 700, color: '#185a9d', fontSize: 20, textShadow: '0 2px 8px #fff8', background: '#fff9', borderRadius: 12, padding: '6px 18px', boxShadow: '0 2px 12px #0001' }, children: "\u00A1Lanza la Pok\u00E9ball hacia arriba para atrapar!" })), _jsxs("div", { style: {
                    pointerEvents: 'none',
                    position: 'absolute',
                    top: '25vh',
                    left: '50%',
                ...
                }, children: [pokemon && (_jsx("img", { src: getSpriteForPokemon(pokemon, stats?.isShiny), alt: pokemon.name, style: pokeSpriteStyle, className: "poke-go-pokemon-sprite", draggable: false })), pokemon && !caught && (_jsx("div", { style: captureCircleStyle }))] }), showPokeball && (_jsxs("div", { style: {
                    ...pokeballStyle,
                    background: 'none',
                    boxShadow: 'none',
                    zIndex: 1201,
                    ...
                    alignItems: 'center',
                    justifyContent: 'center',
                }, children: [pokeballAnim === 'success' && (_jsxs(_Fragment, { children: [_jsxs("div", { style: {
                                    position: 'absolute',
                                    left: '50%',
                                    top: '50%',
                                    transform: 'translate(-50%, -50%)',
                                    ...
                                    height: 160,
                                    pointerEvents: 'none',
                                }, children: [_jsx("div", { className: "star star1", style: { position: 'absolute', left: 10, top: 30, width: 52, height: 50, animation: 'star-pop1 1.2s ease-out' }, children: _jsx("svg", { viewBox: "0 0 52.95 50.35", children: _jsx("polygon", { fill: "#e8e73c", points: "26.47 0 32.72 19.23 52.95 19.23 36.58 31.12 42.83 50.35 26.47 38.47 10.11 50.35 16.36 31.12 0 19.23 20.22 19.23 26.47 0" }) }) }), _jsx("div", { className: "star star2", style: { position: 'absolute', left: 100, top: 0, width: 52, height: 50, animation: 'star-pop2 1.3s ease-out' }, children: _jsx("svg", { viewBox: "0 0 52.95 50.35", children: _jsx("polygon", { fill: "#e8e73c", points: "26.47 0 32.72 19.23 52.95 19.23 36.58 31.12 42.83 50.35 26.47 38.47 10.11 50.35 16.36 31.12 0 19.23 20.22 19.23 26.47 0" }) }) }), _jsx("div", { className: "star star3", style: { position: 'absolute', left: 60, top: 100, width: 52, height: 50, animation: 'star-pop3 1.4s ease-out' }, children: _jsx("svg", { viewBox: "0 0 52.95 50.35", children: _jsx("polygon", { fill: "#e8e73c", points: "26.47 0 32.72 19.23 52.95 19.23 36.58 31.12 42.83 50.35 26.47 38.47 10.11 50.35 16.36 31.12 0 19.23 20.22 19.23 26.47 0" }) }) })] }), _jsx(CaptureConfetti, {})] })), _jsx("img", { ref: pokeballRef, src: getPokeballSprite(selectedBall), alt: "Pok\u00E9ball", style: {
                            width: 90,
                            height: 90,
                            userSelect: 'none',
                            pointerEvents: 'none',
                            ...
                            animation: showBallFailFlash ? 'pokeball-fail-flash 0.35s' : pokeballAnim === 'success'
                                ...
                                : pokeballAnim === 'idle' && pokeballLandingPos === null && !caught && !throwing
                                    ...
                                    : 'none',
                        }, draggable: false })] })), !caught && hasAnyBall && (_jsx("button", { onClick: handleThrow, style: {
                    borderRadius: 999,
                    padding: '18px 38px',
                    fontWeight: 800,
                    color: 'white',
                ...
                }, disabled: throwing, children: "Lanzar" })), showResult && (_jsx("div", { style: {
                    zIndex: 500,
                    position: 'fixed',
                    left: '50%',
                    top: '30vh',
                    ...
                    textAlign: 'center',
                    lineHeight: 1.2,
                }, children: showResult === 'success' ? successMessage : failMessage })), showAppearMessage && pokemon && stats && (_jsxs("div", { style: {
                    position: 'fixed',
                    top: '50%',
                    left: '50%',
                    transform: 'translate(-50%,-50%)',
                    ...
                    lineHeight: 1.25,
                    letterSpacing: 0.2,
                }, children: [_jsx("span", { style: { marginRight: 6 }, children: "\u2728" }), _jsxs("span", { children: ["\u00A1Ha aparecido ", _jsx("span", { style: { color: '#fff' }, children: pokemon.name[0].toUpperCase() + pokemon.name.slice(1) }), " ", _jsxs("span", { style: { fontSize: 15, color: '#fff', marginLeft: 4 }, children: ["#Lv", stats.level] })] }), _jsx("span", { style: { marginLeft: 6 }, children: "\u2728" })] })), pokemon && stats && (_jsxs("div", { style: {
                    position: 'absolute',
                    top: '7vh',
                    left: '50%',
                    transform: 'translateX(-50%)',
                    ...
                    alignItems: 'center',
                    gap: 6,
                }, children: [_jsx("span", { style: { color: '#ffe066', textShadow: '0 0 8px #fff', fontWeight: 800, fontSize: 28 }, children: pokemon.name[0].toUpperCase() + pokemon.name.slice(1) }), _jsxs("span", { style: { fontSize: 18, color: '#fff', fontWeight: 700, background: '#185a9d', borderRadius: 8, padding: '2px 10px', marginLeft: 4, boxShadow: '0 1px 6px #185a9d44' }, children: ["Lv", stats.level] })] })), _jsx(PokeballSelector, {})] }));
}
