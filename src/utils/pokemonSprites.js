...
export function getPokemonSpriteById(pokemonId) {
    return `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/${pokemonId}.gif`;
}
// Función para obtener sprite estático por ID
export function getPokemonStaticSpriteById(pokemonId) {
...
export function getPokemonBasicSpriteById(pokemonId) {
...
export function getPokemonIconUrl(pokemonName) {
    const pokemonId = pokemonNameToId[pokemonName];
    if (pokemonId) {
...
export function getPokemonStaticIconUrl(pokemonName) {
...
export function getShowdownSpriteUrl(pokemonName) {
